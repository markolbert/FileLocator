...
public class MonthDayTimeFormatJsonConverter( ILoggerFactory? loggerFactory ) : JsonConverter<MonthDayTimeFormat>
{
    ...
    public override MonthDayTimeFormat Read( ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options )
    {
        ...
        _logger?.UnsupportedEnumValue( typeof( MonthDayTimeFormat ), text??string.Empty, MonthDayTimeFormat.Numbers.ToString() );
